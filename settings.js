...
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=DiwQGLJK#Qc9TykQHTdjDfqSyXIpYTCIPSVlaL378MJzfsMejBlY' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
PORT: process.env.PORT === undefined ? "8000" : process.env.PORT,
SUDO: process.env.SUDO === undefined ? '94787072548,94704227534' : process.env.SUDO,
SESSION_NAME: process.env.PORT === undefined ? "naveen" : process.env.SESSION_NAME,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*Hello , I am Naveen MD Bot 2025 alive now!!*" : process.env.ALIVE_MSG,
...
NEWS_SEND_JID: process.env.NEWS_SEND_JID === undefined ? "true" : process.env.NEWS_SEND_JID,
